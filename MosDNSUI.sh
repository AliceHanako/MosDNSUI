...
FLASK_PORT=5001
MOSDNS_ADMIN_URL="http://127.0.0.1:9080" # 改成 9080
WEB_USER="www-data"
SYSTEMD_SERVICE_FILE="/etc/systemd/system/$FLASK_APP_NAME.service"

# --- 下载地址 ---
APP_PY_URL="https://raw.githubusercontent.com/AliceHanako/MosDNSUI/main/app.py"
INDEX_HTML_URL="https://raw.githubusercontent.com/AliceHanako/MosDNSUI/main/index.html"
